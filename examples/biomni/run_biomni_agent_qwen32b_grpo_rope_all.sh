...
# 4xA100: tp size -> 2, sequence parallel size -> 4, nnodes -> 4
GPU_MEM_UTIL=0.8
TP_SIZE=2
NNODES=4
SP_SIZE=4
...
PYTHONUNBUFFERED=1 HOME=/dfs/scratch1/lansong uv run --env-file /dfs/scratch1/lansong/SkyRL/.env.biomni -m verl.trainer.main_ppo \
    ...
    trainer.resume_from_path=/dfs/scratch1/lansong/models/qwen/biomni-training-qwen3-32b-grpo/biomni-training-qwen3-32b-32bsz-temp0.6-clip-0.28-32turn-grpo/global_step_108 \
