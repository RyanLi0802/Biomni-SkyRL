...
EXPERIMENT_NAME='biomni-training-qwen3-8b-32bsz-temp0.6-clip-0.28-32turn-grpo-reward2-causal-gene-pharmaprojects'
DATA_PATH="/dfs/project/bioagentos/rl_data/gwas_causal_gene_pharmaprojects"
