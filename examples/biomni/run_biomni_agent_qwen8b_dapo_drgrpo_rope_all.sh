...
PROJECT_NAME='biomni-training-qwen3-8b-drgrpo'
EXPERIMENT_NAME='biomni-training-qwen3-8b-32bsz-temp0.6-clip-0.28-64turn-rope-drgrpo'
...
# 1xH100: tp size -> 2, sequence parallel size -> 2, nnodes -> 1
GPU_MEM_UTIL=0.8
TP_SIZE=2
NNODES=1
SP_SIZE=2
